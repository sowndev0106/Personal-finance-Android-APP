...
//        add speding
    ...
    private void addSpinner(){
        ...
        typeSpendings.add(new TypeSpending( "Tiền điện",R.drawable.noto_pot_of_food, 0));
        typeSpendings.add(new TypeSpending( "Tiền điện",R.drawable.noto_pot_of_food, 0));
        typeSpendings.add(new TypeSpending( "Chi phí khác",R.drawable.noto_pot_of_food, 0));
